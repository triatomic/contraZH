...
// TheSuperHackers @feature for the display string teardown
...
W3DDisplayStringManager::~W3DDisplayStringManager()
{
	// TheSuperHackers @feature The countdown and hotkey overlay strings must come back to
	// the manager while it is still alive; the base class destructor asserts on any string
	// left registered.
	W3DGadgetPushButtonFreeDisplayStrings();
