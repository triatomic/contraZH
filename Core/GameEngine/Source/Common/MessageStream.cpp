...
#define CASE_LABEL(x) case x: return #x;
	...
	CASE_LABEL(MSG_META_SMART_SELECTION_NEXT_TYPE)
	CASE_LABEL(MSG_META_SMART_SELECTION_PREV_TYPE)
	...
	CASE_LABEL(MSG_META_TOGGLE_REVERSEMOVE)
	...
	CASE_LABEL(MSG_CHEAT_KITCHEN_SINK)
	CASE_LABEL(MSG_CHEAT_TOGGLE_ZOOM_LOCK)
	CASE_LABEL(MSG_CHEAT_SHOW_OBJECT_NAME)
	CASE_LABEL(MSG_CHEAT_SHOW_PARTICLE_NAMES)
	CASE_LABEL(MSG_CHEAT_SHOW_COMMAND_SET)
	CASE_LABEL(MSG_CHEAT_SHOW_WEAPON_SET)
	CASE_LABEL(MSG_CHEAT_SHOW_ARMOR_SET)
	CASE_LABEL(MSG_CHEAT_CYCLE_CAMERA_MODE)
	CASE_LABEL(MSG_CHEAT_CYCLE_SKYBOX)
	CASE_LABEL(MSG_CHEAT_CYCLE_TERRAIN_MODE)
	CASE_LABEL(MSG_CHEAT_TOGGLE_FACE_CULLING)
